...
<div
  id="about"
  className="bg-primary w-full h-fit lg:h-min grid grid-cols-wrapperMb grid-rows-wrapperMb lg:grid-rows-wrapperLg lg:grid-cols-wrapperLg px-sectionH sm:px-sectionHSm xl:px-sectionHXl py-sectionV sm:py-sectionVSm xl:py-sectionVXl relative overflow-hidden"
>
  ...
  <div className="flex flex-col lg:flex-row col-start-1 lg:col-start-2 row-start-2 lg:row-start-1 row-span-1 col-span-2 xl:col-span-2 h-auto w-full items-center justify-start xl:pl-[6rem] gap-8 lg:gap-4">
    <Image 
      src={profile}
      alt="David Hill"
